  ...
  return (
    <section className="info">
      ...
      <p>
        ...
        Desa Bandar Khalipah dipimpin oleh seorang Kepala Kampung. Mulai tahun 1961 sampai saat 
        ini barulah Desa Bandar Khalipah dipimpin oleh seorang Kepala Desa, yaitu :
      </p>
        <br />
      <HistoryTable />
    </section>
